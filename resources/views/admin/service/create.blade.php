...
<form action="{{ route('admin.service.store') }}" method="POST" enctype="multipart/form-data">
    ...
    <div class="container">
        ...
        <div class="form-group ml-5">
            <label for="quote" class="col-sm-2 col-form-label">Quote AR</label>
            <div class="col-sm-9">
                <input type="text" name='quote_ar' class="form-control {{$errors->first('quote_ar') ? "is-invalid" : "" }} " value="{{old('quote_ar')}}" id="quote_ar" placeholder="Quote AR">
                <div class="invalid-feedback">
        ...
        <div class="form-group ml-5">
            ...
            <div class="col-sm-9">
                {{-- <input type="text" class="form-control" id="title" placeholder="Title"> --}}
                <textarea name="desc_ar" id="summernote" cols="40" rows="10"  class="form-control {{$errors->first('desc_ar') ? "is-invalid" : "" }} ">{{old('desc_ar')}}</textarea>
                <div class="invalid-feedback">

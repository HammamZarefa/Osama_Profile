...
<form action="{{ route('admin.category.update',$category->id) }}" method="POST">
    ...
    <div class="container">
        ...
        <div class="form-group ml-5">
            ...
            <div class="col-sm-7">
                <input type="text" name='name_ar' class="form-control {{$errors->first('name_ar') ? "is-invalid" : "" }} " value="{{old('name_ar') ? old('name_ar') : $category->name_ar}}" id="name_ar" placeholder="Name AR">
                <div class="invalid-feedback">

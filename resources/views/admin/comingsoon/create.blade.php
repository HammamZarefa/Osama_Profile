...
<form action="{{ route('admin.comingsoon.store') }}" method="POST" enctype="multipart/form-data">
    @csrf
    ...
    <div class="container">
        ...
        <div class="form-group ml-5">
            ...
            <div class="col-sm-9">
                <input type="text" name='client' class="form-control {{$errors->first('client') ? "is-invalid" : "" }} " value="{{old('client')}}" id="client" placeholder="link">
                <div class="invalid-feedback">
                    {{ $errors->first('client') }}
                </div>
            </div>

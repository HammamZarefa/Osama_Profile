  ...
  ======================================================== -->
    ...
    <header id="header" class="fixed-top" >
      <div class="container">
        ...
        <!-- .nav-menu -->
        <div class="header-social-links lg-social">
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-lg-3 col-md-6 footer-contact">
              ...
              <p>
                {{ $local=='en'? $general->address1: $general->address1_ar}} <br>
                {{  $local=='en'?$general->address2:$general->address2_ar }}<br>
            ...
            <div class="col-lg-3 col-md-6 footer-links">
              ...
              <ul>
                @foreach ($lpost as $lpost)
                  <li>
                    @if(session()->get('locale')==='ar')
                      <a href="{{ route('blogshow',$lpost->slug) }}">{{ $lpost->title_ar }}</a>
    ...
    <a href="https://wa.me/96171575052" target="_blank" class=" whatsapp"><i class="bx bxl-whatsapp" aria-hidden="true"></i></a>
    <!-- Vendor JS Files -->
